			...
			{detail ? (
				<div className="flex flex-col gap-[24px]">
					...
					{!isExpanded && isClamped && (
						<button
							className="w-full typo-body2-normal text-label-normal px-[20px] py-[9px] border border-line-neutral rounded-[10px] hover:bg-label-normal/[3.75%] focus:bg-label-normal/[6%] active:bg-label-normal/[9%]"
