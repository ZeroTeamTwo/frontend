...
export default function PrivacyPage() {
	...
	return (
		<div className="flex flex-col w-full max-w-desktop mx-auto px-6 py-8 gap-6 desktop:px-9 desktop:gap-9 desktop:mt-12 desktop:mb-30">
			...
			<p className="pt-5 p">
				그래, 이 픽은 고객의 정보를 소중하게 생각하며, ‘정보통신망 이용 촉진 및 정보보호 등에 관한 법률’, ‘개인정보보호법’ 등 개인정보보호법령을
				철저히 준수합니다. 그래, 이 픽은 아래와 같은 [개인정보처리방침]을 제정하고 이를 준수합니다. 또한, 본 개인정보처리방침은 개인정보와 관련한
				법령의 변경이 있는 경우 또는 그래, 이 픽의 정책 변경 등의 이유로 변경될 수 있습니다. 고객 여러분들께서는 그래, 이 픽이 제공하는 사이트 방문 시
				개인정보처리방침을 수시로 확인하여 주시기 바랍니다.
			</p>
