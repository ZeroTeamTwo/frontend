...
export default async function MyPage() {
	...
	return (
		<div className="flex w-full justify-center min-h-[calc(100vh-64px-94px)] bg-bg-normal-alternative">
			<div className="flex flex-col w-full justify-center items-center gap-5 desktop:flex-row desktop:items-start desktop:pt-7 max-w-maxw">
				<section className="flex flex-col items-center px-5 w-full desktop:px-10 pt-[50px] pb-[32px] desktop:py-14 desktop:w-[387px] gap-6 desktop:gap-9 desktop:border-2 bg-white desktop:border-line-alternative desktop:rounded-[20px]">
